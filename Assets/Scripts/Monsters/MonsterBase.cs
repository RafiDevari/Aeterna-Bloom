...
public class MonsterBase : MonoBehaviour
{
    ...
    [Tooltip("Daftar hasil research yang bisa didapat dari monster ini. Beda-beda tiap prefab child class. " +
             ...
             "'condition' & 'trigger' di tiap entry (lihat komentar di atas struct ResearchEntry).")]
    ...
    protected virtual void Awake()
    {
        ...
        CheckAutoResearch(); // jaga-jaga kalau growth awal (di Inspector) sudah memenuhi syarat Auto entry
    }
    ...
    protected virtual void Update()
    {
        ...
        TickFeedCooldown();
        TickPassiveGrowth();
        CheckAutoResearch(); // dicek tiap frame -- kondisi Custom (mis. suhu ruangan) bisa berubah kapan saja,
                              // bukan cuma pas GrowthState berubah. Aman dipanggil terus karena entry yang
                              // sudah selesai otomatis di-skip.
    ...
    private void UpdateGrowthState()
    {
        ...
        // juga lewat CheckAutoResearch() yang jalan tiap frame di Update().
    }
    ...
    /// <summary>Cek syarat condition sebuah entry terhadap CurrentGrowthState (atau Secret hook).</summary>
    ...
    /// tapi belum selesai. Otomatis kepanggil tiap kali GrowthState berubah & sekali di Awake.
    /// Panggil manual dari child class kalau ada Auto entry yang syaratnya BUKAN dari GrowthState
    /// (mis. ResearchCondition.Secret yang bergantung ke mood/waktu/dll, bukan growth).
    /// </summary>
