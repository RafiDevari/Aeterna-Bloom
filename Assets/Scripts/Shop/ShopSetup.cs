...
public class ShopSetup : MonoBehaviour
{
    ...
    public static void SetupShopScene()
    {
        ...
        catBarRt.anchorMin = new Vector2(0.12f, 0.80f);
        catBarRt.anchorMax = new Vector2(0.88f, 0.89f);
        catBarRt.offsetMin = Vector2.zero;
        catBarRt.offsetMax = Vector2.zero;

        // Category Buttons (Seed, Room, Accessory, Upgrade, Hire)
        GameObject seedBtnObj = CreateButton("SeedCategoryButton", categoryBarObj.transform, "SEED", 18, new Color(0.2f, 0.6f, 1f));
        RectTransform seedRt = seedBtnObj.GetComponent<RectTransform>();
        seedRt.anchorMin = new Vector2(0.00f, 0.1f);
        seedRt.anchorMax = new Vector2(0.18f, 0.9f);
        seedRt.offsetMin = Vector2.zero;
        seedRt.offsetMax = Vector2.zero;

        GameObject roomBtnObj = CreateButton("RoomCategoryButton", categoryBarObj.transform, "ROOM", 18, new Color(0.2f, 0.25f, 0.35f));
        RectTransform roomRt = roomBtnObj.GetComponent<RectTransform>();
        roomRt.anchorMin = new Vector2(0.20f, 0.1f);
        roomRt.anchorMax = new Vector2(0.38f, 0.9f);
        roomRt.offsetMin = Vector2.zero;
        roomRt.offsetMax = Vector2.zero;

        GameObject accBtnObj = CreateButton("AccessoryCategoryButton", categoryBarObj.transform, "ACCESSORY", 18, new Color(0.2f, 0.25f, 0.35f));
        RectTransform accRt = accBtnObj.GetComponent<RectTransform>();
        accRt.anchorMin = new Vector2(0.40f, 0.1f);
        accRt.anchorMax = new Vector2(0.58f, 0.9f);
        accRt.offsetMin = Vector2.zero;
        accRt.offsetMax = Vector2.zero;

        GameObject upgradeBtnObj = CreateButton("UpgradeCategoryButton", categoryBarObj.transform, "UPGRADE", 18, new Color(0.2f, 0.25f, 0.35f));
        RectTransform upgradeRt = upgradeBtnObj.GetComponent<RectTransform>();
        upgradeRt.anchorMin = new Vector2(0.60f, 0.1f);
        upgradeRt.anchorMax = new Vector2(0.78f, 0.9f);
        upgradeRt.offsetMin = Vector2.zero;
        upgradeRt.offsetMax = Vector2.zero;

        GameObject hireBtnObj = CreateButton("HireCategoryButton", categoryBarObj.transform, "HIRE", 18, new Color(0.2f, 0.25f, 0.35f));
        RectTransform hireRt = hireBtnObj.GetComponent<RectTransform>();
        hireRt.anchorMin = new Vector2(0.80f, 0.1f);
        hireRt.anchorMax = new Vector2(0.98f, 0.9f);
        hireRt.offsetMin = Vector2.zero;
        hireRt.offsetMax = Vector2.zero;
        ...
        mgrSo.FindProperty("hireCategoryButton").objectReferenceValue = hireBtnObj.GetComponent<Button>();
        ...
        mgrSo.FindProperty("hireButtonBg").objectReferenceValue = hireBtnObj.GetComponent<Image>();
